...
public class CaptchaUtil {
	 ...
	 * @param width 图片宽
	 * @param height 图片高
	 * @return {@link cn.hutool.captcha.CircleCaptcha}
	 * @since 3.2.3
	 */
	public static cn.hutool.captcha.CircleCaptcha createCircleCaptcha(int width, int height) {
		return new cn.hutool.captcha.CircleCaptcha(width, height);
	}
