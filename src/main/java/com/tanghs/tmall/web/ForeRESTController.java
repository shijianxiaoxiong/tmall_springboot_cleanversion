...
public class ForeRESTController {
    ...
    // 所以这里也需要转义。有些同学在恶意注册的时候，会使用诸如 <script>alert('papapa')</script> 这样的名称，会导致网页打开就弹出一个对话框。 那么在转义之后，就没有这个问题了。
    ...
    public Object product(@PathVariable("pid") int pid) {
        ...
        productImageService.setFirstProdutImage(product);              //设置产品的默认图片
